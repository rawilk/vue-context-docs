...
return [
    ...
    */
    ...
    'cache'       => [
        'enabled' => env('LARECIPE_CACHE_ENABLED', false),
        'period'  => 5
    ],
    ...
    */
    ...
    'seo'                 => [
        'author'          => 'Randall Wilk',
        'description'     => 'vue-context provides a simple yet flexible context menu for Vue. It is styled for the standard tag, but any menu template can be used.',
        'keywords'        => 'Vue, vue-context, context menu',
        'og'              => [
            'title'       => 'vue-context',
            'type'        => 'article',
            'url'         => '',
